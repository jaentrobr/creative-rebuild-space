...
export const Route = createFileRoute("/produtores")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Crie seu evento, acompanhe divulgadores e receba com rapidez pela Entrô.",
      },
    ...
    <>
      <section className="wave-field py-16 sm:py-24">
        <PageShell className="py-0 sm:py-0">
          ...
          <h1 className="max-w-3xl text-5xl font-extrabold leading-none sm:text-7xl">
            Sua festa merece taxa justa.
          </h1>
          <p className="mt-5 max-w-xl text-lg text-muted-foreground">
            Tecnologia simples, repasse ágil e gente de verdade cuidando do seu evento.
          </p>
          {user ? (
      ...
      <PageShell>
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-3">
          {["Crie o evento", "Divulgue com links próprios", "Receba em 48h úteis"].map(
            (step, index) => (
        ...
        <p className="mt-10 text-sm">
          <Link to="/termos-produtor" className="font-bold text-primary underline">
            Termos do produtor
          </Link>
        </p>
      </PageShell>
