...
export function ProducerCta() {
  ...
  return (
    <section className="relative overflow-hidden bg-primary py-14 text-primary-foreground sm:py-20">
      <span className="absolute left-4 top-6 text-3xl text-sun sm:left-10 sm:top-10 sm:text-4xl">✦</span>
      <span className="absolute right-6 top-10 text-2xl text-cta sm:right-16 sm:top-14 sm:text-3xl">ϟ</span>
      <span className="absolute bottom-8 left-8 text-2xl text-sun/60 sm:bottom-12 sm:left-20 sm:text-3xl">✦</span>
